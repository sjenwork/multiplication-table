...
import { AUDIO_ROOTS, CLIP_GAP_MAX_MS, CLIP_GAP_MIN_MS, audioPath, playAudioClip } from '../app/audio.js';
...
test('audio playback rejects when the browser blocks autoplay', async () => {
    ...
    await assert.rejects(playAudioClip(audio, 'female', 2, 1), /NotAllowedError/);
});
